...
describe('A BalancedRoundRobinProcessingAlgorithm', () => {
  ...
  describe('Moving next task to processing', () => {
    describe('Successfully with items in todo list', () => {
      const roundRobinProcessingAlgorithm = new BalancedRoundRobinProcessingAlgorithm(mockList.items, 10, mockCustomers.customers, randomNumberGeneratorMock);
    ...
    describe('Successfully without items in todo list', () => {
      const roundRobinProcessingAlgorithm = new BalancedRoundRobinProcessingAlgorithm([], 10, mockCustomers.customers, randomNumberGeneratorMock);
